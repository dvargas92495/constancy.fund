...
const TermsOfUsePage: React.FC = () => (
  <Container>
    <h1>Terms of Use</h1>
    <p>
      The Constancy website located at https://constancy.fund was founded by
      Humane Capital, LLC. Certain features of the Site may be subject to
    ...
    <h2> Notice Requirement and Informal Dispute Resolution.</h2>
    <p>
    ...
    <h2> Emergency Equitable Relief.</h2>
    <p>
